...
cat "${MKV_DEST}retry_list.txt" | parallel --jobs 5 "rawcooked -y --all ${DPX_PATH}{} -s 5281680 -o ${MKV_DEST}mkv_cooked/{}.mkv &>> ${MKV_DEST}mkv_cooked/{}.mkv.txt"
...
cat "${MKV_DEST}rawcook_list.txt" | parallel --jobs 5 "rawcooked -y --all ${DPX_PATH}{} -s 5281680 -o ${MKV_DEST}mkv_cooked/{}.mkv &>> ${MKV_DEST}mkv_cooked/{}.mkv.txt"
