...
# Path to folder
FPATH="${QNAP_11_DIGIOPS}${DPX_WRAP}"
LOGS="${QNAP_11_DIGIOPS}${DPX_SCRIPT_LOG}tar_wrapping_checksum.log"
FLIST="${QNAP_11_DIGIOPS}${TAR_PRES}temp_file_list.txt"
...
grep "/mnt/" "$FLIST" | parallel --jobs 1 "${PY3_ENV} ${DPX_SCRIPTS}qnap_11_digiops/tar_wrapping_checksum.py {}"
