...
DPX_PATH="${QNAP_FILMOPS}${RAWCOOKED_PATH}"
DPX_DEST="${QNAP_FILMOPS}${DPX_COMPLETE}"
...
grep ^N_ "${MKV_DESTINATION}successful_mkv_list.txt" | parallel --jobs 10 mv "${MKV_DESTINATION}mkv_cooked/{}" "${QNAP_FILMOPS}${MKV_CHECK}{}"
