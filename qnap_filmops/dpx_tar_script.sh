...
LOG_PATH="${QNAP_FILMOPS}${TAR_LOG}"
DPX_PATH="${QNAP_FILMOPS}${DPX_WRAP}"
DESTINATION="${QNAP_FILMOPS}${DPX_TARRED}"
TAR_FAILED="${QNAP_FILMOPS}${TAR_FAIL}"
AUTOINGEST="${QNAP_FILMOPS}${AUTOINGEST_DOC}"
MD5PATH="$MD5_PATH"
