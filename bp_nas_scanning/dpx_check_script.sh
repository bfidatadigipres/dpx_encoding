...
MKV_PATH="${BP_FILM_SCANNING}${MKV_CHECK}"
MKV_LOG="${BP_FILM_SCANNING}${MKV_ENCODED}logs/"
MKV_KILLED="${BP_FILM_SCANNING}${MKV_ENCODED}killed/"
MKV_AUTOINGEST="${BP_FILM_SCANNING}${AUTOINGEST_VID}"
DPX_PATH="${BP_FILM_SCANNING}${DPX_COMPLETE}"
DPX_TO_COOK="${BP_FILM_SCANNING}${DPX_COOK}"
FOR_DELETION="${BP_FILM_SCANNING}${TO_DELETE}"
DPX_LOG="${BP_FILM_SCANNING}${DPX_SCRIPT_LOG}"
ERRORS="${BP_FILM_SCANNING}${CURRENT_ERRORS}"
ERRORS_DONE="${BP_FILM_SCANNING}${CURRENT_ERRORS}completed/"
