...
MKV_PATH="${QNAP_FILMOPS2}${MKV_CHECK}"
MKV_LOG="${QNAP_FILMOPS2}${MKV_ENCODED}logs/"
MKV_KILLED="${QNAP_FILMOPS2}${MKV_ENCODED}killed/"
MKV_AUTOINGEST="${QNAP_FILMOPS2}${AUTOINGEST_VID}"
DPX_PATH="${QNAP_FILMOPS2}${DPX_COMPLETE}"
DPX_TO_COOK="${QNAP_FILMOPS2}${DPX_COOK}"
