...
# Path to folder
FPATH="${QNAP_FILMOPS2}${DPX_WRAP}"
LOGS="${QNAP_FILMOPS2}${DPX_SCRIPT_LOG}tar_wrapping_checksum.log"
FLIST="${QNAP_FILMOPS2}${TAR_PRES}temp_file_list.txt"
...
grep "/mnt/" "$FLIST" | parallel --jobs 1 "${PY3_ENV} ${DPX_SCRIPTS}qnap_filmops2/tar_wrapping_checksum.py {}"
