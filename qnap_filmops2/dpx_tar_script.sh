...
LOG_PATH="${QNAP_FILMOPS2}${TAR_LOG}"
DPX_PATH="${QNAP_FILMOPS2}${DPX_WRAP}"
DESTINATION="${QNAP_FILMOPS2}${DPX_TARRED}"
TAR_FAILED="${QNAP_FILMOPS2}${TAR_FAIL}"
AUTOINGEST="${QNAP_FILMOPS2}${AUTOINGEST_DOC}"
MD5PATH="$MD5_PATH"
...
# Add date to end of TAR MD5 record for persistence.py usage
