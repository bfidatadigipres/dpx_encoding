...
MKV_PATH="${QNAP_10_DIGIOPS}${MKV_CHECK}"
MKV_LOG="${QNAP_10_DIGIOPS}${MKV_ENCODED}logs/"
MKV_KILLED="${QNAP_10_DIGIOPS}${MKV_ENCODED}killed/"
MKV_AUTOINGEST="${QNAP_10_DIGIOPS}${AUTOINGEST_VID}"
DPX_PATH="${QNAP_10_DIGIOPS}${DPX_COMPLETE}"
DPX_TO_COOK="${QNAP_10_DIGIOPS}${DPX_COOK}"
FOR_DELETION="${QNAP_10_DIGIOPS}${TO_DELETE}"
DPX_LOG="${QNAP_10_DIGIOPS}${DPX_SCRIPT_LOG}"
ERRORS="${QNAP_10_DIGIOPS}${CURRENT_ERRORS}"
ERRORS_DONE="${QNAP_10_DIGIOPS}${CURRENT_ERRORS}completed/"
