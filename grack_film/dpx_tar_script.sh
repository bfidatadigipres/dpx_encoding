...
LOG_PATH="${GRACK_FILM}${TAR_LOG}"
DPX_PATH="${GRACK_FILM}${DPX_WRAP}"
DESTINATION="${GRACK_FILM}${DPX_TARRED}"
TAR_FAILED="${GRACK_FILM}${TAR_FAIL}"
AUTOINGEST="${GRACK_FILM}${AUTOINGEST_DOC}"
MD5PATH="$MD5_PATH"
