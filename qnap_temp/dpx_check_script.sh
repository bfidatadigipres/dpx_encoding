...
MKV_PATH="${QNAP_TEMP}${MKV_CHECK}"
MKV_LOG="${QNAP_TEMP}${MKV_ENCODED}logs/"
MKV_KILLED="${QNAP_TEMP}${MKV_ENCODED}killed/"
MKV_AUTOINGEST="${QNAP_TEMP}${AUTOINGEST_VID}"
DPX_PATH="${QNAP_TEMP}${DPX_COMPLETE}"
DPX_TO_COOK="${QNAP_TEMP}${DPX_COOK}"
FOR_DELETION="${QNAP_TEMP}${TO_DELETE}"
DPX_LOG="${QNAP_TEMP}${DPX_SCRIPT_LOG}"
ERRORS="${QNAP_TEMP}${CURRENT_ERRORS}"
ERRORS_DONE="${QNAP_TEMP}${CURRENT_ERRORS}completed/"
