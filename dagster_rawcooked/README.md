...
```bash
dagster dev --host <machine IP> --port 8080
```
...
Tests are in the `dagster_rawcooked_tests` directory and you can run tests using `pytest`:

```bash
pytest dagster_rawcooked_tests
```
