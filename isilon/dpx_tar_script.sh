...
LOG_PATH="${ISILON}${TAR_LOG}"
DPX_PATH="${ISILON}${DPX_WRAP}"
DESTINATION="${ISILON}${DPX_TARRED}"
TAR_FAILED="${ISILON}${TAR_FAIL}"
AUTOINGEST="${ISILON}${AUTOINGEST_DOC}"
MD5PATH="$MD5_PATH"
ERRORS="${ISILON}${CURRENT_ERRORS}"
