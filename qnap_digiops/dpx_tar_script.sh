...
LOG_PATH="${QNAP_DIGIOPS}${TAR_LOG}"
DPX_PATH="${QNAP_DIGIOPS}${DPX_WRAP}"
DESTINATION="${QNAP_DIGIOPS}${DPX_TARRED}"
TAR_FAILED="${QNAP_DIGIOPS}${TAR_FAIL}"
AUTOINGEST="${QNAP_DIGIOPS}${AUTOINGEST_DOC}"
MD5PATH="$MD5_PATH"
